...
def index():
    ...
    if request.method == 'POST':
        ...
        # Initialize all_ticker_data here to resolve the "undefined variable" warning.
        all_ticker_data = {}
        ...
        try:
            initial_investment_f = float(request.form.get('initial_investment'))
            investment_years_i = int(request.form.get('investment_years'))
        ...
        for ticker_symbol in tickers:
            ...
            try:
                ...
                # Add data to all_ticker_data (initialized above try/except)
        ...
        if results and any(not r['error'] for r in results):
            ...
            years = list(range(investment_years_i + 1))
...
def export_csv():
    ...
    for ticker_symbol in tickers:
        ...
        try:
            # Re-fetch data for export consistency
            quote_data = finnhub_client.quote(ticker_symbol)
            current_price = quote_data.get('c')
